...
public class FollowController {
	...
	public String followers(Model model, @PathVariable("uid") int userId) {
		...
		int count = (int) followService.getFollowerCount(userId, EntityType.ENTITY_USER);
		List<Integer> followers = followService.getFollowers(userId, EntityType.ENTITY_USER, count);
		// 将用户粉丝的用户信息传给前端
